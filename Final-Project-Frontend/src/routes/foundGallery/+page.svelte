...
<div class="flex">
  ...
  <div class="flex flex-col items-start ml-5 mt-5">
    ...
    <a href="/reunitedGallery" class="btn btn-accent mb-3" style="width: 200px">Reunited Pets Gallery</a>
  </div>

  <!-- Cards -->
  <div class="overflow-x-auto w-full mr-5 basis-3/4" style="padding: 50px">
    <div class="flex flex-wrap justify-center gap-10">
      {#each data.pet.filter(pet => (selectedType === 'all' || pet.pet_type.toLowerCase() === selectedType.toLowerCase()) && pet.pet_status === 'Found') as pet}
